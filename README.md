...
具体编译使用流程如下
 ...
 ```bash
curl https://github.com/laowagong/cf-yxip/releases/latest/download/linux.tar.gz -o linux.tar.gz
...
``` bash
curl https://proxy.freecdn.workers.dev/?url=https://raw.githubusercontent.com/laowagong/cf-yxip/main/shell/cf.sh -o cf.sh && chmod +x cf.sh && ./cf.sh
```
